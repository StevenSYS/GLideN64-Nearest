...
#define BILINEAR_NEAREST  0
#define BILINEAR_3POINT   1
#define BILINEAR_STANDARD 2
#define BILINEAR_3POINT_WITH_COLOR_BLEEDING 3
#define BILINEAR_STANDARD_WITH_COLOR_BLEEDING_AND_PREMULTIPLIED_ALPHA 4
